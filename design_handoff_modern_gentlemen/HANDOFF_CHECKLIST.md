...
- [ ] Remaining Section Library modules — map each to a block + `variant` per `MODULE_MAP.md`; build the flagged TODO archetypes (spec table, membership-tiers block, the 10 showcase "Vogue" heroes at full fidelity).
