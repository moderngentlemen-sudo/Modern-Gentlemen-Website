      ...
      >
        <div className="flex items-center justify-between p-6 border-b border-mg-bd/10">
          ...
          <button
            ...
            className="grid place-items-center h-10 w-10 rounded-full border border-mg-bd/20 text-lg leading-none"
          >
            ×
          </button>
        </div>
        ...
        {cart.lines.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-5 p-8 text-center">
            ...
            <Link
              href="/shop"
              onClick={onClose}
              className="font-mono text-xs uppercase tracking-[0.2em] border border-mg-bd/30 px-6 py-3"
            >
              Browse the store →
            </Link>
          </div>
          ...
          <>
            ...
            <div className="border-t border-mg-bd/10 p-6 space-y-3">
              ...
              <div className="flex justify-between font-grotesk text-lg">
                <span>Subtotal</span>
              ...
              <Link
                href="/checkout"
                onClick={onClose}
                className="block text-center bg-mg-accent text-white py-3 font-mono text-xs uppercase tracking-[0.2em]"
              >
                Checkout
              </Link>
              <Link
