...
function HeroFull({ kicker, title, dek, byline, image }: HeroProps) {
  return (
...
function HeroContained({ kicker, title, dek, byline, image }: HeroProps) {
  return (
...
function HeroCover({ kicker, title, dek, byline, image }: HeroProps) {
  return (
    <section data-darkband className="relative -mt-[72px] bg-[#0d0d0d] text-[#f4f4f4]">
...
function HeroWide({ kicker, title, dek, byline, image }: HeroProps) {
  return (
    <section data-darkband className="relative -mt-[72px] bg-[#0d0d0d] text-[#f4f4f4]">
...
function HeroPortrait({ kicker, title, byline, image }: HeroProps) {
  return (
    <section data-darkband className="relative -mt-[72px] bg-[#0d0d0d] text-[#f4f4f4]">
...
function HeroSplit({ kicker, title, dek, byline, image }: HeroProps) {
  return (
    <section
      data-split
...
function HeroMasthead({ kicker, title, dek, byline }: HeroProps) {
  return (
...
function HeroCentered({ kicker, title, dek, byline }: HeroProps) {
  return (
