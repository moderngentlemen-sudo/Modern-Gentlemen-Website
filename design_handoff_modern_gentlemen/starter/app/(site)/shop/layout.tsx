 ...
 *
 * The async layout also frames the singleton shop archive when an assignment
 * exists. The client page remains the marker content, so filtering stays a
 * hydrated enhancement rather than turning the route into request rendering.
 */
