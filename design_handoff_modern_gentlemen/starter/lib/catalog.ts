...
export const products: Product[] = [
  {
    ...
    story:
      "We wanted a watch roll that wasn’t precious about itself — something you could throw in a duffel and forget. The shell is a dry, British-milled waxed canvas that softens with handling; the interior is a brushed suede that won’t mark a polished case.\n\nThree padded slots hold cases up to 44mm, and the whole thing rolls down to the size of a paperback. It ships flat and breaks in fast.",
    specs: [
      ["Capacity", "3 watches, up to 44mm"],
      ["Shell", "Waxed cotton canvas"],
      ["Lining", "Brushed microsuede"],
  ...
  },
  {
    ...
    cat: "Watches",
    catLabel: "WATCHES",
    name: "Suede Two-Piece Strap, 20mm",
    price: 52,
    tag: "",
    ...
    story:
      "Cut from a soft, closely-napped Italian suede and backed with a water-resistant membrane so a caught shower doesn’t ruin the afternoon. Quick-release spring bars mean you can change it without tools in under a minute.\n\nAvailable in a taupe that flatters almost everything and a deep petrol blue for the brave.",
    specs: [
      ["Lug width", "20mm"],
      ["Material", "Italian suede"],
      ["Backing", "Water-resistant membrane"],
      ["Hardware", "Quick-release spring bars"],
  ...
  },
  {
    ...
    story:
      "Cut from a breathable Italian hopsack and built without shoulder padding or chest canvas, so it moves and packs like knitwear but reads as a proper blazer across a table.\n\nHalf-lined in cupro for shape, with patch pockets and a soft natural shoulder. Wear it over a tee or a knit; it does both without complaint.",
    specs: [
      ["Cloth", "Italian hopsack wool"],
      ["Construction", "Unstructured, half-lined"],
      ["Lining", "Cupro"],
      ["Pockets", "Three patch"],
      ["Buttons", "Corozo"],
      ["Made in", "Portugal"],
  ...
  },
  {
    ...
    story:
      "Woven on vintage shuttle looms in Okayama from a 14oz natural-indigo yarn, then cut to a straight, slightly tapered leg that works with boots or sneakers.\n\nThese start rigid and fade to a personal map of everywhere you sit, walk and lean. Wear them hard, wash them rarely.",
    specs: [
      ["Weight", "14oz"],
      ["Denim", "Japanese selvedge"],
      ["Dye", "Natural indigo"],
      ["Fit", "Straight, slight taper"],
  ...
  },
  {
    ...
    cat: "Style",
    catLabel: "STYLE",
    name: "Everyday Oxford, Button-Down",
    price: 110,
    tag: "",
    ...
    story:
      "A proper oxford-cloth button-down in a soft, long-staple cotton that only gets better with washing. The collar rolls the way a good OCBD collar should — no fusing, no stiff board look.\n\nA relaxed-but-not-boxy fit that tucks cleanly or hangs well untucked over denim.",
    specs: [
      ["Cloth", "Long-staple cotton oxford"],
      ["Collar", "Unlined button-down"],
      ["Fit", "Relaxed classic"],
  ...
  },
  {
    ...
    cat: "Style",
    catLabel: "STYLE",
    name: "Fine-Gauge Merino Crew",
    price: 130,
    tag: "",
    material: "Extra-fine merino · fully-fashioned",
    blurb: "A thin, warm crew that layers under a blazer without any bulk.",
    story:
      "Knitted from an extra-fine 19.5-micron merino that feels smooth rather than scratchy against the skin, in a gauge fine enough to disappear under tailoring.\n\nFully-fashioned seams keep the shoulders clean, and it holds its shape through a whole winter of wear.",
    specs: [
      ["Yarn", "Extra-fine merino, 19.5μm"],
      ["Gauge", "14gg fine"],
      ["Seams", "Fully-fashioned"],
      ["Neck", "Ribbed crew"],
      ["Care", "Cool hand wash"],
      ["Made in", "Scotland"],
    ],
  ...
  },
  {
    ...
    cat: "Grooming",
    catLabel: "GROOMING",
    name: "The Seven-Minute Kit",
    price: 68,
    tag: "BESTSELLER",
    material: "Face wash · moisturiser · balm",
    blurb: "Everything for a face, nothing you’ll never use — three steps, seven minutes.",
    story:
      "We got tired of nine-bottle routines nobody keeps up. This is three things done well: a gentle gel cleanser, a light SPF-free day moisturiser, and a beard-and-jaw balm that doubles as a post-shave.\n\nAll fragrance-light, all in refillable aluminium, all sized to fit a dopp kit. Start here.",
    specs: [
      ["Contains", "Cleanser, moisturiser, balm"],
      ["Cleanser", "100ml gel"],
      ["Moisturiser", "50ml light"],
      ["Balm", "30ml"],
  ...
  },
  {
    ...
    cat: "Grooming",
    catLabel: "GROOMING",
    name: "Machined Safety Razor Set",
    price: 78,
    tag: "",
    material: "Machined brass · 20 blades",
    blurb: "One razor, a lifetime of five-pence blades, and a closer shave.",
    story:
      "A weighty, closed-comb safety razor machined from solid brass that will outlive every cartridge system you’ve owned. The heft does the work, so you press less and nick less.\n\nComes with a stand and a starter tin of twenty Swedish steel blades.",
    specs: [
      ["Material", "Machined brass"],
      ["Head", "Closed comb"],
      ["Weight", "98g"],
      ["Includes", "Stand + 20 blades"],
  ...
  },
  {
    ...
    story:
      "Cut from a single piece of vegetable-tanned full-grain leather and saddle-stitched by hand, this holds four cards snugly and a couple of folded notes in the centre.\n\nStarts firm and tan, ages to a deep honey patina that’s entirely your own.",
    specs: [
      ["Leather", "Veg-tanned full-grain"],
      ["Capacity", "4 cards + notes"],
      ["Stitch", "Hand saddle-stitch"],
      ["Slots", "2 outer, 1 centre"],
  ...
  },
  {
    ...
    cat: "Accessories",
    catLabel: "ACCESSORIES",
    name: "Brass Shoe Horn, Long",
    price: 38,
    tag: "",
    material: "Solid brass · 60cm",
    blurb: "The small dignity of never crushing the heel of a good shoe again.",
    story:
      "A 60cm solid-brass shoe horn so you can put on shoes standing up, like an adult. Weighty, cool to the touch, and handsome enough to leave by the door.\n\nThe brass develops a soft patina; leave it or polish it, both look right.",
    specs: [
      ["Material", "Solid brass"],
      ["Length", "60cm"],
      ["Weight", "240g"],
      ["Finish", "Raw, patinating"],
  ...
  },
  {
    ...
    cat: "Accessories",
    catLabel: "ACCESSORIES",
    name: "Weekender Holdall, Waxed",
    price: 265,
    tag: "NEW",
    material: "Waxed canvas · bridle leather",
    blurb: "Two nights away in one bag that looks better the more it’s used.",
    story:
      "A generous carry-all in the same dry waxed canvas as our watch roll, trimmed in English bridle leather and riveted where it counts. Fits two nights of clothes, a dopp kit and a pair of shoes.\n\nAn interior zip pocket keeps a passport and charger findable, and the base is reinforced so it stands up on its own.",
    specs: [
      ["Shell", "Waxed cotton canvas"],
      ["Trim", "English bridle leather"],
      ["Capacity", "38 litres"],
      ["Base", "Reinforced, footed"],
  ...
  },
  {
    ...
    cat: "Style",
    catLabel: "STYLE",
    name: "Ribbed Wool Watch Cap",
    price: 45,
    tag: "",
    material: "Lambswool · ribbed knit",
    blurb: "A short, honest beanie with no logo and no slouch.",
    story:
      "A tight-ribbed watch cap in soft lambswool, knitted short so it sits at the ear without swallowing your head. No branding, no pom, no fuss.\n\nWarm enough for a real winter, thin enough to stuff in a coat pocket.",
    specs: [
      ["Yarn", "Lambswool"],
      ["Knit", "Ribbed"],
      ["Fit", "Short cuff"],
  ...
  },
  {
    ...
    cat: "Accessories",
    catLabel: "ACCESSORIES",
    name: "Bridle Leather Belt, 35mm",
    price: 95,
    tag: "",
    material: "English bridle leather · solid brass",
    blurb: "One belt, cut to your length, that you’ll re-buckle for a decade.",
    story:
      "Cut from a strip of English bridle leather and finished with a solid-brass roller buckle you can swap yourself. We punch it to your waist so it sits on the middle hole from day one.\n\nA true buy-it-for-life belt that darkens handsomely with wear.",
    specs: [
      ["Leather", "English bridle"],
      ["Width", "35mm"],
      ["Buckle", "Solid brass roller"],
      ["Fixing", "Screw-set, swappable"],
...
export const byGroup = (group: string) =>
